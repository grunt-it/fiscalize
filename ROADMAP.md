...
An order or invoice event maps to fiscalize (FURS) + e-invoice (e-SLOG/UBL),
consumed by a separate integration track. fiscalize stays framework-agnostic;
the integration wraps it.
